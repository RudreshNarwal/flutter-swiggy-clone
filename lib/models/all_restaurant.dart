...
class AllRestaurant {
  ...
  static const restaurantListOne = [
  ...
  static const restaurantListTwo = [
    SpotlightBestTopFood(
      image: 'assets/images/food4.jpg',
      name: 'Biryani Expresss',
      desc: 'North Indian',
  ...
  static const restaurantListThree = [
    SpotlightBestTopFood(
      image: 'assets/images/food4.jpg',
      name: 'Biryani Expresss',
      desc: 'North Indian',
  ...
  static const indianRestaurants = [
...
class LargeRestaurantBanner {
  ...
  static const bestInSafetyRestaurants = [
  ...
  static const pepsiSaveOurRestaurants = [
    LargeRestaurantBanner(
